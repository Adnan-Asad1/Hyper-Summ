...
# Find and modify the dataset loading cell (cell index 3, execution_count 4)
for cell in notebook['cells']:
    if cell.get('execution_count') == 4 or (cell.get('id') == '05ed9913'):
        # Replace the dataset loading logic
        new_source = [
            "import os\\n",
            "import json\\n",
            "import requests\\n",
        ...
        print(f"Modified cell with id: {cell.get('id')}")
        break
...
print("The dataset loading has been modified to create longer articles by combining 4 related articles from the same category.")
