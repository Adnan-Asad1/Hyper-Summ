...
# Find and fix TF-IDF Parallel cell
for cell in notebook['cells']:
    if cell.get('id') == 'f41f7ebd':  # TF-IDF Parallel cell
        cell['source'] = [
            "def process_chunk(chunk: str) -> Tuple[List[str], Dict[int, float]]:\n",
            "    \"\"\"\n",
            "    Process a single text chunk and compute sentence scores\n",
            "    \"\"\"\n",
            "    sentences, cleaned_text = preprocess_text(chunk)\n",
            "    \n",
            ...
            "                    if len(word_idx) > 0:\n",
            "                        score += tfidf_matrix[0, word_idx[0]]\n",
            "            \n",
            ...
            "    Simplified version: process chunks directly \n",
            "    \"\"\"\n",
            "    \n",
            ...
            "        \"\"\"\n",
            "        Generate summary using simplified parallel approach\n",
            ...
            "            \n",
            "            # Compute TF-IDF for entire document (faster than per-chunk)\n",
            "            vectorizer = TfidfVectorizer(\n",
            "                max_features=5000,\n",
            "                min_df=1,\n",
            "                max_df=0.9,\n",
        ...
        print("Fixed TF-IDF Parallel cell")
        break
